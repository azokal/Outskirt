...
public class BossThree extends BasicBoss {
	...
	public BossThree(Game game, float maxLife, float timing) {
		...
		this.bossPart[0] = new BossThreePart(game, maxLife, this,
				Game.Color.GREEN, timing);
		this.bossPart[1] = new BossThreePart(game, maxLife, this,
				Game.Color.CYAN, timing);
		this.bossPart[2] = new BossThreePart(game, maxLife, this,
				Game.Color.RED, timing);
		for (int a = 0; a < 360; a += 360 / 9) {
			this.bossPart[3 + a / (360 / 9)] = new SpiralBossMob(game, a, 90,
