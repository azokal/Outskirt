...
public class BossTwo extends BasicBoss {
	...
	public BossTwo(Game game, float maxLife, float timing) {
		...
		this.bossPart[0] = new BossTwoPart(game, maxLife, this, Game.Color.GREEN, timing);
		this.bossPart[1] = new BossTwoPart(game, maxLife, this, Game.Color.CYAN, timing);
		this.bossPart[2] = new BossTwoPart(game, maxLife, this, Game.Color.RED, timing);
		this.timing = timing;
	}
