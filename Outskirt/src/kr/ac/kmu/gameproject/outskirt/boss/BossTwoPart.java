...
public class BossTwoPart extends Life {
	...
	public BossTwoPart(Game game, float maxLife, BossTwo owner, Game.Color color, float timing) {
		super(game, maxLife);
		this.color = color;
		this.owner = owner;
		oSprite = new sprites.Sprite(game.getApp(),game.pathSprites+"diamondGrid.png", 3, 1, 10);
		oSprite.setScale(2);
		this.setPolar(50, 0);
